...
const mockedDexscreener = dexscreener;
const mockedNormalizer = normalizer;
const mockedJupiter = jupiter;
const mockedState = state;
const mockedWsHub = wsHub;
const mockedMerge = merge;
...
describe('Poller', () => {
    ...
    it('should execute the full polling, merging, and caching flow', async () => {
        ...
        mockedNormalizer.normalizeTokenData
            .mockReturnValueOnce(mockNormalized1)
            .mockReturnValueOnce(mockNormalized2);
        ...
        mockedMerge.mergeTokens.mockReturnValue(mockMergedTokens);
        ...
        // 6. Merge data
        expect(mockedMerge.mergeTokens).toHaveBeenCalledWith([mockNormalized1, mockNormalized2], // dexTokens
    ...
    it('should handle zero SOL price gracefully', async () => {
        ...
        // 4. Mock normalizer.normalizeTokenData
        const mockNormalized1 = { address: 'addr1', priceNative: 0.1 };
        mockedNormalizer.normalizeTokenData.mockReturnValueOnce(mockNormalized1);
        ...
        expect(mockedMerge.mergeTokens).toHaveBeenCalledWith([mockNormalized1], mockJupPrices, 0 // solPriceUsd
        );
    });
});
